...
import plus.data.solubility as solubility
...
parser = argparse.ArgumentParser('Train a Model on Solubility Datasets')
...
def main():
    ...
    output, save_prefix = set_output(args, "train_solubility_log")
    ...
    dataset_train = solubility.load_solubility(data_cfg, "train", alphabet, args["sanity_check"])
    ...
    dataset_dev = solubility.load_solubility(data_cfg, "dev", alphabet, args["sanity_check"])

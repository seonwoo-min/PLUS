...
parser = argparse.ArgumentParser('Train a Model on Localization Datasets')
...
def main():
    ...
    dataset_train = localization.load_localization(data_cfg, "train", alphabet, args["sanity_check"])
    ...
    dataset_dev = localization.load_localization(data_cfg, "dev", alphabet, args["sanity_check"])

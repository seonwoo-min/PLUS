...
import plus.data.stability as ss
...
parser = argparse.ArgumentParser('Train a Model on Stability Datasets')
...
def main():
    ...
    output, save_prefix = set_output(args, "train_stability_log")
    ...
    dataset_train = ss.load_stability(data_cfg, "train", alphabet, args["sanity_check"])
    ...
    dataset_dev = ss.load_stability(data_cfg, "dev", alphabet, args["sanity_check"])

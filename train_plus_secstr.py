...
parser = argparse.ArgumentParser('Train a Model on SecStr Datasets')
...
def main():
    ...
    output, save_prefix = set_output(args, "train_secstr_log")
    ...
    dataset_train = secstr.load_secstr(data_cfg, "train", alphabet, args["sanity_check"])
    ...
    iterator_train = torch.utils.data.DataLoader(dataset_train, run_cfg.batch_size_train, collate_fn=collate_fn)
    ...
    dataset_dev = secstr.load_secstr(data_cfg, "dev", alphabet, args["sanity_check"])
